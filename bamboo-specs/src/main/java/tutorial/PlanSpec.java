...
public class PlanSpec {
	...
	Project project() {
		return new Project().name("MyBambooBuildSpecProject").key("MYBBSPRJ123");
	}
        ...
        return new Plan(
                ...
                .stages(new Stage("Stage1123").jobs(new Job("JOB1","JOBKEY123")	
                		.tasks(
                				...
                				new MavenTask().enabled(true).executableLabel("maven 3").jdk("JDK 1.8").goal("clean test -Denv=${env}")
                				)));
    }
